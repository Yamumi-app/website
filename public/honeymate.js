!(function () {
  ...
  var i = function (e) {
      return e.right ? 2 : e.down ? 3 : e.left ? 4 : 1;
    },
    o = function (e, t) {
    ...
    a = function (e, t) {
      t.opacity = "ease-out";
      for (var n = "", i = Object.entries(t), o = 0; o < i.length; o++) {
        var a = r(i[o], 2),
          s = a[0],
          c = a[1];
        n += "".concat(s, " ").concat(e, "ms ").concat(c, ", ");
      }
    ...
    c = function (e) {
      ...
      if (t.background && "" !== t.background) {
        var n = t.background.match(s);
        return n ? n[2] : "";
      }
      if (t.backgroundImage && "" !== t.backgroundImage) {
        var r = t.backgroundImage.match(s);
        return r ? r[2] : "";
      }
    },
    u = function (e) {
      return new Promise(function (t) {
        var n = Array.from(e.querySelectorAll("*"));
        n.push(e);
        var r = (function (e) {
          for (var t = [], n = 0; n < e.length; n++)
            if ("IMG" === e[n].tagName) t.push(e[n].src);
            else {
              var r = c(e[n]);
              r && t.push(r);
            }
      ...
      return (
        n(t, [
              ...
              var e = this,
                t =
                  arguments.length > 0 && void 0 !== arguments[0]
                    ? arguments[0]
                    : this.effect;
              o(this.node, t).then(function () {
                Promise.all([
                  e.parameters.expose ? e.isInView() : null,
                  e.isLoaded(),
                ]).then(function () {
                  setTimeout(function () {
                    return e.expose();
          ...
          },
          {
            ...
            value: function () {
              var e = this;
              o(this.node, { transform: "", opacity: 1 }).then(function () {
                var t;
                e.parameters.spin &&
                  ((t = e.spinner),
          ...
          },
          {
            ...
            set: function (e) {
              ...
              ((this.parameters = {
                direction: i((t = e)),
                duration: t.duration || 640,
                effect: t.effect || "",
                expose: "true" === t.expose && "IntersectionObserver" in window,
                delay: parseInt(t.delay, 10) || 0,
                hold: parseInt(t.hold, 10) || 0,
                scale: t.scale || ".87",
                await: t.await || null,
                origin: t.origin || "bottom",
                offset:
                  t.up || t.down || t.left || t.right
                    ? t.up || t.down || t.left || t.right
                    : 32,
                spin: "true" === t.spin,
                spinColor: t["spin-color"] || "#000",
                spinSize: t["spin-size"] || 24,
                continue: "true" === t.continue,
              }),
                      ...
                      ((o.transition = a(i, {
                        ...
                        (o.transform =
                          ...
                          "translate"
                            .concat((r += 1 === t || 2 === t ? "(-" : "("))
                            .concat(n, "px)"))),
                        (o.transformOrigin = e.origin));
                      break;
                    case "relax":
                      ((o.transition = a(i, {
                        transform: "cubic-bezier(0,0,0,1)",
                      })),
                        (o.transform = "scaleY(".concat(e.scale, ")")),
                        (o.transformOrigin = e.origin));
                      break;
                    default:
                      o.transition = a(i, {});
                ...
                this.parameters.spin &&
                  (this.spinner =
                    ...
                    (f.innerHTML =
                      ((r = n.parameters.spinSize),
                      (s = n.parameters.spinColor),
                      '<svg width="'
                        .concat(r, '" height="')
                        .concat(
                          r,
                          '" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" style="animation: honeySpin 1.7s linear infinite"><circle cx="50" cy="50" fill="none" stroke="',
                        )
                        .concat(
                          s,
                          '" stroke-width="10" r="35" stroke-dasharray="90 60"></circle></svg>',
                        ))),
                    setTimeout(function () {
                      return o(f, {
                        position: "absolute",
                        top: u.top + l.scrollTop + "px",
                        left: u.left + l.scrollLeft + "px",
    ...
    m = function (e, t) {
      if (e.continue && t > 1)
        return ((r = t - 1), l.get(Array.from(l.keys())[r]));
      if (e.await) {
        var n = document.querySelectorAll("#" + e.await)[0];
        return n ? d(n) : void 0;
      }
      var r;
    },
        ...
        n(t, null, [
          {
            ...
            value: function () {
              for (
                var e = document.querySelectorAll(".honey"),
                  t = function (t) {
                    var n = d(e[t]),
                      r = m(n.parameters, t);
                    r
                      ? r.isLoaded().then(function () {
                          setTimeout(function () {
                            return n.animate();
                          }, n.parameters.hold);
                        })
